...
{
    public partial class Admin_V100 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<long>(type: "bigint", nullable: false, comment: "Id主键"),
                    AuthorName = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true, comment: "作者姓名")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TablePrefix = table.Column<string>(type: "varchar(5)", maxLength: 5, nullable: true, comment: "是否移除表前缀")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    GenerateType = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true, comment: "生成方式")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TableName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true, comment: "数据库表名")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    NameSpace = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true, comment: "命名空间")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    BusName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true, comment: "业务名")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MenuApplication = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "菜单应用分类")
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColumnName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false, comment: "数据库字段名")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ColumnComment = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true, comment: "字段描述")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    NetType = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: ".NET数据类型")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    EffectType = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "作用类型")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FkEntityName = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "外键实体名称")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FkColumnName = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "外键显示字段")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FkColumnNetType = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "外键显示字段.NET类型")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DictTypeCode = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "字典Code")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    WhetherRetract = table.Column<string>(type: "varchar(5)", maxLength: 5, nullable: true, comment: "列表是否缩进")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    WhetherRequired = table.Column<string>(type: "varchar(5)", maxLength: 5, nullable: true, comment: "是否必填")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    QueryWhether = table.Column<string>(type: "varchar(5)", maxLength: 5, nullable: true, comment: "是否是查询条件")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    QueryType = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: true, comment: "查询方式")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    WhetherTable = table.Column<string>(type: "varchar(5)", maxLength: 5, nullable: true, comment: "列表显示")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    WhetherOrderBy = table.Column<string>(type: "varchar(5)", maxLength: 5, nullable: true, comment: "列表是否排序")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    WhetherAddUpdate = table.Column<string>(type: "varchar(5)", maxLength: 5, nullable: true, comment: "增改")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ColumnKey = table.Column<string>(type: "varchar(5)", maxLength: 5, nullable: true, comment: "主键")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DataType = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "数据库中类型")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    WhetherCommon = table.Column<string>(type: "varchar(5)", maxLength: 5, nullable: true, comment: "是否通用字段")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedTime = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true, comment: "创建时间"),
                    UpdatedTime = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true, comment: "更新时间"),
                    CreatedUserId = table.Column<long>(type: "bigint", nullable: true, comment: "创建者Id"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Code = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false, comment: "编码")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Value = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "属性值")
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileBucket = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true, comment: "文件仓库")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FileOriginName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true, comment: "文件名称")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FileSuffix = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "文件后缀")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FileSizeKb = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: true, comment: "文件大小kb")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FileSizeInfo = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "文件大小信息")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FileObjectName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true, comment: "存储到bucket的名称")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FilePath = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true, comment: "存储路径")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedTime = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true, comment: "创建时间"),
                    UpdatedTime = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true, comment: "更新时间"),
                    CreatedUserId = table.Column<long>(type: "bigint", nullable: true, comment: "创建者Id"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserName = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true, comment: "操作人名称")
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Account = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true, comment: "操作人")
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ip = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true, comment: "IP")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Location = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true, comment: "地址")
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ip = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true, comment: "IP")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Location = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true, comment: "地址")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Browser = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true, comment: "浏览器")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Os = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true, comment: "操作系统")
                    ...
                    Account = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true, comment: "访问人")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TenantId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<long>(type: "bigint", nullable: false, comment: "Id主键"),
                    Title = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false, comment: "标题")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    PublicUserName = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true, comment: "发布人姓名")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PublicOrgId = table.Column<long>(type: "bigint", nullable: false, comment: "发布机构Id"),
                    PublicOrgName = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "发布机构名称")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PublicTime = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true, comment: "发布时间"),
                    CancelTime = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true, comment: "撤回时间"),
                    Status = table.Column<int>(type: "int", nullable: false, comment: "状态"),
                    CreatedTime = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true, comment: "创建时间"),
                    UpdatedTime = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true, comment: "更新时间"),
                    CreatedUserId = table.Column<long>(type: "bigint", nullable: true, comment: "创建者Id"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReadTime = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true, comment: "阅读时间"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<long>(type: "bigint", nullable: false, comment: "Id主键"),
                    Uuid = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "UUID")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AccessToken = table.Column<string>(type: "longtext", nullable: true, comment: "Token")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    Avatar = table.Column<string>(type: "longtext", nullable: true, comment: "头像")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Gender = table.Column<string>(type: "varchar(5)", maxLength: 5, nullable: true, comment: "性别")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Phone = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true, comment: "电话")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Email = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true, comment: "邮箱")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Location = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "位置")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Blog = table.Column<string>(type: "longtext", nullable: true, comment: "用户网址")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Company = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "所在公司")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Source = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true, comment: "用户来源")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Remark = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true, comment: "备注")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedTime = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true, comment: "创建时间"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<long>(type: "bigint", nullable: false, comment: "用户Id")
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ConnectionId = table.Column<string>(type: "longtext", nullable: true, comment: "连接Id")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    LastTime = table.Column<DateTime>(type: "datetime(6)", nullable: false, comment: "最近时间")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<long>(type: "bigint", nullable: false, comment: "Id主键"),
                    JobName = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false, comment: "任务名称")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DoOnce = table.Column<bool>(type: "tinyint(1)", nullable: false, comment: "只执行一次"),
                    StartNow = table.Column<bool>(type: "tinyint(1)", nullable: false, comment: "立即执行"),
                    ...
                    Cron = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true, comment: "Cron表达式")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TimerType = table.Column<int>(type: "int", nullable: false, comment: "定时器类型"),
                    RequestUrl = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: true, comment: "请求url")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    RequestParameters = table.Column<string>(type: "longtext", nullable: true, comment: "请求参数")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Headers = table.Column<string>(type: "longtext", nullable: true, comment: "Headers")
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 142307070918743L, "system", "sys_monitor_mgr_online_user_list", null, null, null, null, null, false, null, "在线用户列表", 0, "sysOnlineUser:list", 142307070918742L, "[0],[142307070918739],[142307070918742],", null, null, null, 100, 0, 2, null, null, null, "Y", 1 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 142307070914648L, "manage", "sys_menu_mgr_grant_tree", null, null, null, null, null, false, null, "菜单授权树", 0, "sysMenu:treeForGrant", 142307070914651L, "[0],[142307070914633],[142307070914651],", null, null, null, 100, 0, 2, null, null, null, "Y", 1 },
                    { 142307070914649L, "manage", "sys_menu_mgr_tree", null, null, null, null, null, false, null, "菜单树", 0, "sysMenu:tree", 142307070914651L, "[0],[142307070914633],[142307070914651],", null, null, null, 100, 0, 2, null, null, null, "Y", 1 },
